...
public class SuAnaliziActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_su_analizi);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                SuAnaliziActivity.this.onBackPressed();
            }
        });
    ...
    public void setData() {
        ...
        yValues1.add(new Entry(1, 34));
        yValues1.add(new Entry(2, 38));
        yValues1.add(new Entry(3, 45));
        yValues1.add(new Entry(4, 40));
        yValues1.add(new Entry(5, 38));
        ...
        set.setCircleColor(ContextCompat.getColor(getApplicationContext(), R.color.waterColor));
        set.setCircleRadius(4);
        set.setDrawValues(false);
        set.setColor(ContextCompat.getColor(getApplicationContext(), R.color.waterColor));
        set.setLineWidth(4);
