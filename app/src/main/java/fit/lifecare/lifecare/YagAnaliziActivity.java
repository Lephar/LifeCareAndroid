...
public class YagAnaliziActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_yag_analizi);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                YagAnaliziActivity.this.onBackPressed();
            }
        });
    ...
    public void setData() {
        ...
        yValues1.add(new Entry(2, 23));
        yValues1.add(new Entry(3, 37));
        yValues1.add(new Entry(4, 45));
        yValues1.add(new Entry(5, 34));
        yValues1.add(new Entry(6, 42));
        yValues1.add(new Entry(7, 28));
        ...
        set.setCircleColor(ContextCompat.getColor(getApplicationContext(), R.color.ourOrange));
        set.setCircleRadius(4);
        set.setDrawValues(false);
        set.setColor(ContextCompat.getColor(getApplicationContext(), R.color.ourOrange));
        set.setLineWidth(4);
