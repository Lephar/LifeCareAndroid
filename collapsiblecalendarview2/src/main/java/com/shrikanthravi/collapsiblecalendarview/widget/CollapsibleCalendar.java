...
public class CollapsibleCalendar extends UICalendar {
    ...
    protected void init(Context context) {
        ...
        View margin1 = findViewById(R.id.view);
        View margin2 = findViewById(R.id.view2);

        margin1.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
        ...
        margin2.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                expandIconView.performClick();
            }
